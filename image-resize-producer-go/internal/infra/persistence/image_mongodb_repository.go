...
import (
	...
	"github.com/DiegoJCordeiro/image-resizing-go-producer-api/internal/infra/persistence/collections"
	"go.mongodb.org/mongo-driver/v2/bson"
	"go.mongodb.org/mongo-driver/v2/mongo"
)

const (
	collectionName = "image_process"
)
...
// GetImage getting an image by uid
...
// InsertImage deleting an image by uid
...
// DeleteImage deleting an image by uid
